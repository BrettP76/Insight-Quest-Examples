...
$Reports = $ActiveWorkspaces | ForEach-Object -Parallel {$WSID = $_.Id; Get-PowerBIReport -Scope Organization -WorkspaceId $WSID | `
    Where-Object {$_.Name -ne "Dashboard Usage Metrics Report" -and $_.Name -ne "Report Usage Metrics Report"} | `
